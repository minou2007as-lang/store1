...
type OrderStatus = 'open' | 'in_progress' | 'delivered' | 'completed' | 'auto_released' | 'cancelled'
...
export function OrderTimeline({
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: 'in_progress',
      completed: ['delivered', 'completed', 'auto_released', 'confirmed'].includes(status),
    },
    {
      id: 'delivered',
      label: 'Delivered',
      ...
      icon: 'delivered',
      completed: ['completed', 'confirmed', 'auto_released'].includes(status),
