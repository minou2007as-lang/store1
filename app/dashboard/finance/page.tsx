...
export default function FinancePage() {
    ...
    return (
      <div className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-2">Admin access is required to view finance reports.</p>
        </div>
        <Card className="text-center py-8">
          <p className="text-slate-600">You do not have permission to view finance data.</p>
        </Card>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">Finance Dashboard</h1>
        <p className="text-slate-600 mt-2">Full visibility into top-ups, withdrawals and fees.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-600 mt-1">Completed top-up amount</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-600 mt-1">Approved withdrawal amount</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-600 mt-1">Platform fee revenue</p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card>
          <CardHeader>
            <CardTitle>Monthly Finance Trends</CardTitle>
            <CardDescription>Top-ups, withdrawals and fees</CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={320}>
              <LineChart data={chartData}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="topups" stroke="#10b981" strokeWidth={2} name="Top-ups" />
                <Line type="monotone" dataKey="withdrawals" stroke="#f97316" strokeWidth={2} name="Withdrawals" />
                <Line type="monotone" dataKey="fees" stroke="#3b82f6" strokeWidth={2} name="Fees" />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Orders Completed Trend</CardTitle>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={320}>
              <BarChart data={chartData}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="completedOrders" fill="#7c3aed" name="Completed Orders" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
